...
- Respondre qüestions teòriques per blocs sobre tots els continguts de la UT2
- Demostrar la comprensió dels conceptes clau de Linux, LDAP i SSSD
...
- :material-notebook-edit:{ .lg }
    ...
    [:octicons-arrow-right-24: Obrir el quadern](https://quadern-digital-v11-2.vercel.app/moduls/mp224/unitat_treball2.html?id=preguntes){ .md-button .md-button--primary }
