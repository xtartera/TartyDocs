...
=== ":material-notebook-outline: Apunts"
    ...
    !!! info "El valor `userPassword` es genera amb `slappasswd`"
        El camp `userPassword: {SSHA}...` no es pot inventar — és un hash criptogràfic. A la pàgina [23 — slappasswd](../bloc5-ldap-usuaris/23-slappasswd-hash.md) aprendràs a generar-lo. Per ara, els fitxers LDIF que crees al Bloc 4 no inclouran `userPassword`.
...
=== ":material-pencil-ruler: Activitat"
    ...
    **Temps estimat**: 20 minuts
    ...
    !!! info "No aplicis els fitxers LDIF encara"
        Aplicar fitxers LDIF requereix `ldapadd`, que aprendràs a la pàgina [24 — ldapadd](../bloc5-ldap-usuaris/24-ldapadd-usuaris-grups.md). Per ara, prepara els fitxers i verifica la seva sintaxi visualment.
